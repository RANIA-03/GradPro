...
class TheAppBottomNavigator extends StatefulWidget {
  const TheAppBottomNavigator({super.key, required this.callbackFunction});
  final Function callbackFunction;

  @override
  State<TheAppBottomNavigator> createState() => _TheAppBottomNavigatorState();
}

class _TheAppBottomNavigatorState extends State<TheAppBottomNavigator> {
